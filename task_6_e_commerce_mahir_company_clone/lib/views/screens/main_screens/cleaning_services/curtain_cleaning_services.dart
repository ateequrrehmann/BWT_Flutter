...
class CurtainCleaningServices extends ConsumerStatefulWidget {
  const CurtainCleaningServices({super.key});

  @override
  ConsumerState<CurtainCleaningServices> createState() => _ACServicesState();
}

class _ACServicesState extends ConsumerState<CurtainCleaningServices> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Curtain Cleaning'),
        ),
        body: Consumer(builder: (context, ref, child) {
          final service = ref.watch(cleaningServicesProvider('curtain'));
                ...
                itemBuilder: (context, index) {
                  ...
                  if(data.available==true){
                    return reusableCardForServices(
                        ...
                        data.available,'curtain','cleaning_services',quantityValue);
                  }
