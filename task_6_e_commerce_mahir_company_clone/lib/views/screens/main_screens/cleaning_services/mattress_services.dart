...
class MattressCleaningServices extends ConsumerStatefulWidget {
  const MattressCleaningServices({super.key});

  @override
  ConsumerState<MattressCleaningServices> createState() => _ACServicesState();
}

class _ACServicesState extends ConsumerState<MattressCleaningServices> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Mattress Cleaning'),
        ),
        body: Consumer(builder: (context, ref, child) {
          final service = ref.watch(cleaningServicesProvider('mattress'));
                ...
                itemBuilder: (context, index) {
                  ...
                  if(data.available==true){
                    return reusableCardForServices(
                        ...
                        data.available,'mattress','cleaning_services',quantityValue);
                  }
