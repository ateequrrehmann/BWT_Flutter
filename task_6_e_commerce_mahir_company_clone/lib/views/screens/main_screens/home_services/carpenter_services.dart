...
class CarpenterServices extends ConsumerStatefulWidget {
  const CarpenterServices({super.key});

  @override
  ConsumerState<CarpenterServices> createState() => _ACServicesState();
}

class _ACServicesState extends ConsumerState<CarpenterServices> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Consumer(builder: (context, ref, child) {
          final service = ref.watch(homeServicesProvider('carpenter'));
